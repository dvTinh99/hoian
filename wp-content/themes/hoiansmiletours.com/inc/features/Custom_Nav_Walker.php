...
class Custom_Nav_Walker extends Walker_Nav_Menu {
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
        $output .= '<ul class="nav-menu-mobile x-nav-menu x-nav-menu_main-menu x-animate-sign-flip">';
    }
    ...
    public function start_el(&$output , $item , $depth = 0, $args = array() , $id = 0){
        ...
        $class_li .= ' menu-item menu-item-type-post_type menu-item-object-page x-menu-item x-item-menu-standard';
        ...
        if(in_array('current-menu-item', $arr_class_li)){
            $class_li .= ' current-menu-item current_page_item';
            $class_a .= ' current-menu-item current_page_item';
        }
        /* menu-item menu-item-type-custom 
        menu-item-object-custom current-menu-item 
        current_page_item menu-item-home menu-item-6 */
        $class_li = !empty($class_li) ? ' class="'.esc_attr($class_li) .'" ':'';
        $class_a = !empty($class_a) ? ' class="'.esc_attr($class_a) .'x-menu-a-text"':'class="x-menu-a-text"';
